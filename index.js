...
client.once('ready', async () => {
  console.log(`${client.user.tag} — Alles live & direct werkend!`);
  ...
  // Eerst alles wissen + dan opnieuw registreren → geen dubbels + werkt meteen
  for (const guild of client.guilds.cache.values()) {
    await guild.commands.set([]);                    // oude wissen
    await guild.commands.set(commands);              // nieuwe zetten
    console.log(`Commands gefixed in ${guild.name}`);
  }
});
